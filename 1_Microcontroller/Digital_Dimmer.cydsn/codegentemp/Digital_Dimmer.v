// ======================================================================
// Digital_Dimmer.v generated from TopDesign.cysch
// 05/07/2024 at 17:20
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ac9c311c-ba8b-44c4-b350-989ee605ef82/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
    ...
    defparam Status.NumInputs = 4;

	wire [0:0] tmpOE__In_0_net;
	wire [0:0] tmpIO_0__In_0_net;
	wire [0:0] tmpINTERRUPT_0__In_0_net;
	electrical [0:0] tmpSIOVREF__In_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		In_0
		 (.oe(tmpOE__In_0_net),
		  .y({1'b0}),
		  .fb({Net_11}),
		  .io({tmpIO_0__In_0_net[0:0]}),
		  .siovref(tmpSIOVREF__In_0_net),
		  .interrupt({tmpINTERRUPT_0__In_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__In_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("5890f943-6326-4342-bbc3-d6c94ff7f75d"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("27b7461e-e619-42c0-8815-93624fff9add"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Out_0_net;
	wire [0:0] tmpFB_0__Out_0_net;
	wire [0:0] tmpIO_0__Out_0_net;
	wire [0:0] tmpINTERRUPT_0__Out_0_net;
	electrical [0:0] tmpSIOVREF__Out_0_net;
	...
	cy_psoc3_pins_v1_10
		...
		Out_0
		 (.oe(tmpOE__Out_0_net),
		  .y({Net_100}),
		  .fb({tmpFB_0__Out_0_net[0:0]}),
		  .io({tmpIO_0__Out_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Out_0_net),
		  .interrupt({tmpINTERRUPT_0__Out_0_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Out_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("ee287d37-7500-492c-87f9-ef4324f79af3"),
		  .drive_mode(3'b011),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("c329267e-671d-4ff2-a487-5ddd04bd0414"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("0ed3e0a4-e82e-49eb-8eb5-95df3d8093e2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("8b57b2f3-ee6e-40ff-b535-c167813495de"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("e5fc6215-9cf1-4e4a-b059-4ff59d43622f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Dimmer_net;
	wire [0:0] tmpFB_0__Dimmer_net;
	wire [0:0] tmpIO_0__Dimmer_net;
	wire [0:0] tmpINTERRUPT_0__Dimmer_net;
	electrical [0:0] tmpSIOVREF__Dimmer_net;

	cy_psoc3_pins_v1_10
		#(.id("8f3f01d7-e2f2-4624-a415-ad72d4882b6f"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Dimmer
		 (.oe(tmpOE__Dimmer_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Dimmer_net[0:0]}),
		  .io({tmpIO_0__Dimmer_net[0:0]}),
		  .siovref(tmpSIOVREF__Dimmer_net),
		  .interrupt({tmpINTERRUPT_0__Dimmer_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Dimmer_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
