...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDBIF_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F3231u, /* Base address: 0x400F3200 Count: 49 */
			0x400F3325u, /* Base address: 0x400F3300 Count: 37 */
			0x400F400Cu, /* Base address: 0x400F4000 Count: 12 */
			0x400F4112u, /* Base address: 0x400F4100 Count: 18 */
		...
		CY_SET_REG32((void *)(CYREG_HSIOM_PORT_SEL1), 0x00003330u);
		...
		CY_SET_REG32((void *)(CYREG_UDB_PA1_CFG8), 0x00630000u);
	...
	CY_SET_REG32((void *)(CYREG_GPIO_PRT0_PC), 0x006006DEu);

	/* IOPINS0_1 Starting address: CYDEV_GPIO_PRT1_BASE */
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT1_BASE), 0x0000000Eu);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT1_PC), 0x00000DB0u);
	...
	CY_SET_REG32((void *)(CYDEV_GPIO_PRT3_BASE), 0x00000001u);
	CY_SET_REG32((void *)(CYREG_GPIO_PRT3_PC), 0x00000D8Au);
